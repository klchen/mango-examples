...
void example1(u8* data, size_t size)
{
    ...
    // compress with maximum compression (10)
...
/*
    ...
    the input and output memory blocks.

    Notice how the example1 does first compure the bound() so that the correct
