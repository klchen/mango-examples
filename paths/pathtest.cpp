...
void test22()
{
    File file("data/case1.mgx/bench/IMG_2177.JPG");
    print(file);
}

void test23()
{
    Path path("data/case1.mgx/");
    print(path);
...
void test24()
{
    Path path("data/case1.mgx/bench/");
    print(path);
...
{
#if 1
    File file(Path("data/case1.mgx/"), "bench/IMG_2177.JPG");
    print(file);
#endif
}
